...
if [ $? -eq 0 ]; then
    ...
    cat /home/kolibri/Desktop/Updation_script/static_files/platform.sh >> /home/kolibri/platform.sh;
    echo 's' | sudo -S chmod 777 /home/kolibri/platform.sh;
    ...
    chmod 777 /home/kolibri/Desktop/script_sync.sh;
    echo 's' | sudo -S truncate -s 0 /home/kolibri/Desktop/script_sync.sh;
    cat /home/kolibri/Desktop/Updation_script/static_files/script_sync.sh >> /home/kolibri/Desktop/script_sync.sh;
     chmod 777 /home/kolibri/Desktop/script_sync.sh;
